...
class AppFixtures extends Fixture implements ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user->setEmail('darshanaslp@gmail.com');
...
*/
			...
			$category = new Category();
            $category->setName('chid ');
            $category->setDescription('children books ');
            $manager->persist($category);
            $manager->flush();

            $book = new Book();
            $book->setName('A Christmas Carol ');
            $book->setPrice(200);
            ...
            $category->setDescription('adults and young');
            $manager->persist($category);
            $manager->flush();
